(function(){
    ...
    { 
        ...
        autorefresh  : true  , 
        log_internal : false  ,
        cssLoader    : "overflow: hidden; border:0; margin:0; padding:0;box-sizing: border-box; background-image: url('#url#ui/img/logo-rounded.svg'); background-attachment: fixed; height: 100%;width: 100%; height: 100vh;width: 100vw; background-position: center center; background-repeat: no-repeat; background-size: 75% !important;",
        ...
        stairs : function(value)
        {
            ...
            {  
                ...
                {   
                    ...
                    if( that.getModule(item.url) == "ui.img.favicon.ico")
                    {
                         that.log("sys.core.loader",  "run mobile detect" );
        ...
        { 
            ...
            document.addEventListener("DOMContentLoaded", function(event) 
            {
                ...
                if( navigator.onLine != undefined )
                {
                    ...
                    {
                        /*alert("Esta app necesita conexion a internet para continuar");*/
                        
                        document.getElementById("info").innerHTML = "Esta app necesita conexion a internet para continuar<br><a href='javascript:location.reload()' style='color:white; padding-top:5px;'>Volver a Comprobar</a>";
